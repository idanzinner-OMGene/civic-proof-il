...
- **Tests:** Workspace run (no Docker smoke): **540 passed, 0 skipped** (last run, 2026-05-02). **197/197** alignment smoke rows; **5/5** regression. **`make eval`** exits 0 with current gates.
