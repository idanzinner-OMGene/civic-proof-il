// Graph retrieval for claim_type = committee_membership.
// Parameters: $speaker_person_id, $committee_id, $time_start, $time_end.
MATCH (p:Person {person_id: $speaker_person_id})-[r:MEMBER_OF_COMMITTEE]->(c:Committee {committee_id: $committee_id})
...
RETURN
  {speaker_person_id: p.person_id, committee_id: c.committee_id} AS node_ids,
